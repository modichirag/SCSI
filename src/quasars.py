...
def qso_callback(idx, b, interpolant, dataloader, device, results_folder, losses=None, qdataloader=None, validation_data=None, s=None):
    ...
    for _ in range(ns):
        ...
        clean = interpolant.transport(b, obs, None)
